...
type GetTargetWeightScreenNavigationProp = NativeStackNavigationProp<AuthStackParamList, 'GetTargetWeight'>;
type GetTargetWeightScreenRouteProp = RouteProp<AuthStackParamList, 'GetTargetWeight'>;
