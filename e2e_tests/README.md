...
> **📚 Перед написанием новых тестов:** Обязательно ознакомьтесь с [E2E_TEST_DEVELOPMENT_GUIDE.md](./E2E_TEST_DEVELOPMENT_GUIDE.md)  
> Это руководство содержит паттерны работы с аккаунтами, структуру тестов и best practices.
...
## 📚 Руководство по разработке E2E тестов

**⚠️ ВАЖНО:** Перед написанием новых тестов обязательно ознакомьтесь с [E2E_TEST_DEVELOPMENT_GUIDE.md](./E2E_TEST_DEVELOPMENT_GUIDE.md)

Это руководство содержит:
- Паттерны работы с аккаунтами (создание нового пользователя vs использование существующего)
- Стандартную структуру тестовых файлов
- Best practices для написания тестов
- Примеры из реальных тестов проекта
- Чеклист при создании нового теста

### Основные паттерны работы с аккаунтами:

1. **Новый пользователь для каждого теста** - полная изоляция
2. **Shared user на класс** - переиспользование между тестами одного класса
3. **Module-scoped user** - один пользователь на весь файл тестов
4. **Существующий пользователь** - быстрые smoke-тесты

Подробности и примеры смотрите в [E2E_TEST_DEVELOPMENT_GUIDE.md](./E2E_TEST_DEVELOPMENT_GUIDE.md)
...
8. **Следуйте паттернам работы с аккаунтами** - см. [E2E_TEST_DEVELOPMENT_GUIDE.md](./E2E_TEST_DEVELOPMENT_GUIDE.md)
